...
class AdminController extends ChangeNotifier {
  ...
  void _seed() {
    ...
    void addUser(String fullName, String username, String email, String phone, AdminRole role, int daysAgo, {String status = 'Active', String verification = 'Verified', bool archived = false}) {
    ...
    addUser('Aileen Reyes', 'aileen.r', 'aileen@sarisarihub.ph', '0927 555 0177', AdminRole.employee, 120, verification: 'Unverified');
    addUser('Noel Bautista', 'noel.b', 'noel@sarisarihub.ph', '0916 555 0188', AdminRole.employee, 95, status: 'Inactive');
    ...
    addUser('Grace Ocampo', 'grace.o', 'grace.ocampo@yahoo.com', '0921 555 0299', AdminRole.customer, 40, verification: 'Unverified');
